...
| 참조 문서 | [Internal Schedule](Internal%20Schedule.internal.md), [Project Overview](Project%20Overview.md), [Screen Specification](Screen%20Specification.md), [API Specification](API%20Specification.md), [Project Schedule](Project%20Schedule.md), [Day 16](../Log/Development%20Log/Day%2016.md), [현재 개발 단계 리뷰](ai/20260414-%ED%98%84%EC%9E%AC%EA%B0%9C%EB%B0%9C%EB%8B%A8%EA%B3%84%EB%A6%AC%EB%B7%B0/review-%ED%98%84%EC%9E%AC%EA%B0%9C%EB%B0%9C%EB%8B%A8%EA%B3%84%EB%A6%AC%EB%B7%B0.internal.md) |
...
| 구간             | 로그                                                                                             | 설명                                          |
| -------------- | ---------------------------------------------------------------------------------------------- | ------------------------------------------- |
| Week 1         | [Day 1](../Log/Development%20Log/Day%2001.md) ~ [Day 7](../Log/Development%20Log/Day%2007.md)  | 인프라, Testcontainers, REST Docs, 모니터링, 보안 기반 |
| Core API       | [Day 8](../Log/Development%20Log/Day%2008.md) ~ [Day 11](../Log/Development%20Log/Day%2011.md) | 인증, 기록, 랭킹, 게시판 API 기준선                     |
| Frontend 연동 기반 | [Day 12](../Log/Development%20Log/Day%2012.md)                                                 | `AuthContext`, 타이머, 스크램블/기록 저장 연동           |
| 프런트 목업 기준선     | [Day 13](../Log/Development%20Log/Day%2013.md)                                                 | 서비스형 UI 목업과 화면 요구사항 기준선                     |
| 최신 로그          | [Day 16](../Log/Development%20Log/Day%2016.md)                                                 | 커뮤니티/댓글/홈/피드백 실연동, 문서 동기화, 자동/수동 검증 완료      |
...
- 프런트 mock -> 실연동 전환: [Screen Specification](Screen%20Specification.md), [Day 13](../Log/Development%20Log/Day%2013.md), [Day 14](../Log/Development%20Log/Day%2014.md), [Day 16](../Log/Development%20Log/Day%2016.md)
- 테스트/문서화/CI 기준선: [Day 2](../Log/Development%20Log/Day%2002.md), [Day 3](../Log/Development%20Log/Day%2003.md), [Day 4](../Log/Development%20Log/Day%2004.md)

## 최근 정리 문서

- 최근 일자 로그: [Day 16](../Log/Development%20Log/Day%2016.md)
- 현재 작업 요약: [Day 16](../Log/Development%20Log/Day%2016.md)
- 현재 단계 리뷰: [현재 개발 단계 리뷰](ai/20260414-%ED%98%84%EC%9E%AC%EA%B0%9C%EB%B0%9C%EB%8B%A8%EA%B3%84%EB%A6%AC%EB%B7%B0/review-%ED%98%84%EC%9E%AC%EA%B0%9C%EB%B0%9C%EB%8B%A8%EA%B3%84%EB%A6%AC%EB%B7%B0.internal.md)
