...
created: 2026-01-08
updated: 2026-01-08
question: "제네릭(Generics): 타입 안정성을 지키는 수호자"
domain: java
related_topics: []
...
- [자바 컬렉션 선택 기준과 내부 동작](./자바%20컬렉션%20선택%20기준과%20내부%20동작.md)
- [자바의 컬렉션 프레임워크](./자바의%20컬렉션%20프레임워크.md)
- [자바는 컴파일 언어인가, 인터프리터 언어인가](./자바는%20컴파일%20언어인가,%20인터프리터%20언어인가.md)
